---
title: exporterとインテグレーション
sort_rank: 4
---

# exporter<span class="anchor-text-supplement">s and integrations</span>とインテグレーション
...
## <span class="anchor-text-supplement">Third-party </span>サードパーティのexporter<span class="anchor-text-supplement">s</span>
...
### <span class="anchor-text-supplement">Databases</span>データベース
...
### <span class="anchor-text-supplement">Hardware related</span>ハードウェア関連
...
### <span class="anchor-text-supplement">Messaging systems</span>メッセージングシステム
...
### <span class="anchor-text-supplement">Logging</span>ログ
   * [Fluentd exporter](https://github.com/V3ckt0r/fluentd_exporter)
   * [Google's mtail log data extractor](https://github.com/google/mtail)
   * [Grok exporter](https://github.com/fstab/grok_exporter)

### <span class="anchor-text-supplement">Other monitoring systems</span>他の監視システム
...
## <span class="anchor-text-supplement">Software exposing </span>Prometheus<span class="anchor-text-supplement"> metrics</span>メトリクスを出力するソフトウェア
...
## <span class="anchor-text-supplement">Other third-party utilities</span>その他のサードパーティーのユーティリティ
