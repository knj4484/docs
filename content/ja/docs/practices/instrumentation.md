...
#### <span class="original-header">Failures</span>エラー
...
## <span class="original-header">Things to watch out for</span>注意点

監視をする際には、一般的な注意すべき点があり、Prometheusに固有な特に注意すべき点もある。

### <span class="original-header">Use labels</span>ラベルを使う
...
### <span class="original-header">Do not overuse labels</span>ラベルを使い過ぎない
...
### <span class="original-header">Avoid missing metrics</span>メトリクスの欠落の回避
