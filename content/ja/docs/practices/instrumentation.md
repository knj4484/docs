...
# <span class="original-header">Instrumentation</span>メトリクスの組み込み

このページは、自分のコードにメトリクスを組み込むためのガイドライン集を提供する。

## <span class="original-header">How to instrument</span>メトリクスの組み込み方
...
### <span class="original-header">The three types of services</span>サービスの3タイプ
...
#### <span class="original-header">Batch jobs</span><span class="anchor-text-supplement">Batch jobs</span>バッチジョブ
...
### <span class="original-header">Subsystems</span>サブシステム

サービスの主な3タイプに加えて、システムは監視されるべき構成要素がある。

#### <span class="original-header">Libraries</span>ライブラリ
...
#### <span class="original-header">Logging</span>ログ出力
...
#### <span class="original-header">Failures</span><span class="anchor-text-supplement">Failures</span>エラー
...
### <span class="original-header">Counter vs. gauge, summary vs. histogram</span>カウンターvsゲージ、サマリーvsヒストグラム
...
### <span class="original-header">Timestamps, not time since</span>経過時間ではなくタイムスタンプ
