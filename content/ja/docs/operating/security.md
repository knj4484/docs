...
# <span class="original-header">Security Model</span>セキュリテイモデル
...
## <span class="original-header">Authentication, Authorization, and Encryption</span>認証、認可、暗号化
...
## <span class="original-header">Secrets</span>秘密情報
...
## <span class="original-header">Denial of Service</span>サービス妨害
...
## <span class="original-header">Build Process</span>ビルドプロセス
...
## <span class="original-header">External audits</span>外部監査
